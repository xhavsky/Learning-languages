            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                gradient: RadialGradient(
                  ...
                  radius: 1.2,
                  colors: [
                    seed.withValues(alpha: bright ? 0.14 : 0.18),
                    Colors.transparent,
                  ],
                ),
              ),
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                gradient: RadialGradient(
                  ...
                  radius: 1.05,
                  colors: [
                    accent.withValues(alpha: bright ? 0.10 : 0.14),
                    Colors.transparent,
                  ],
                ),
              ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: accent.withValues(alpha: bright ? 0.22 : 0.30),
            blurRadius: 10,
...
/// Soft elevated surface — bez blur/szkła.
...
/// Gradient-filled primary action (np. „Sprawdź”).
